...
function handleSalesTypeChange() {
    ...
    // Once an invoice exists in the system, lock sales type to avoid inconsistent unit/price changes.
    if (typeof currentInvoice !== 'undefined' && currentInvoice && currentInvoice.id) {
        return;
    }
