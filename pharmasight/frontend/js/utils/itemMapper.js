...
(function () {
    ...
    function mapApiItemToDisplay(item) {
        ...
        return {
            ...
            supplier_unit: item.supplier_unit || null,
            wholesale_unit: item.wholesale_unit || null,
            pack_size: item.pack_size != null ? Number(item.pack_size) : null,
            wholesale_units_per_supplier: item.wholesale_units_per_supplier != null ? Number(item.wholesale_units_per_supplier) : null,
            can_break_bulk: item.can_break_bulk != null ? !!item.can_break_bulk : false,
            ...
            setup_complete: item.setup_complete !== undefined ? !!item.setup_complete : true,
