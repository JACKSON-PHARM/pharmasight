...
const API = {
    ...
    hospitalEconomic: {
        patientWorkspace: (patientId) => api.get(`/api/hospital/economic/patients/${patientId}/workspace`),
        getPfj: (pfjId) => api.get(`/api/hospital/economic/pfj/${pfjId}`),
        activePfjForPatient: (patientId) => api.get(`/api/hospital/economic/pfj/for-patient/${patientId}/active`),
        timeline: (pfjId) => api.get(`/api/hospital/economic/pfj/${pfjId}/timeline`),
        liabilitySummary: (pfjId) => api.get(`/api/hospital/economic/pfj/${pfjId}/liability-summary`),
        getCoverage: (pfjId) => api.get(`/api/hospital/economic/pfj/${pfjId}/coverage`),
        upsertCoverage: (pfjId, data) => api.put(`/api/hospital/economic/pfj/${pfjId}/coverage`, data),
        listCharges: (params) => api.get('/api/hospital/economic/charges', params),
        createAuthorization: (pfjId, data) => api.post(`/api/hospital/economic/pfj/${pfjId}/authorizations`, data),
        decideAuthorization: (authId, data) => api.patch(`/api/hospital/economic/authorizations/${authId}`, data),
        recognizePatient: (pfjId) => api.post(`/api/hospital/economic/pfj/${pfjId}/recognize/patient`, null),
        recognizeInsurer: (pfjId) => api.post(`/api/hospital/economic/pfj/${pfjId}/recognize/insurer`, null),
        buildClaim: (pfjId, data) => api.post(`/api/hospital/economic/pfj/${pfjId}/build-claim`, data || {}),
        discharge: (pfjId, data) => api.post(`/api/hospital/economic/pfj/${pfjId}/discharge`, data || {}),
    },
    ...
    hospitalEconomic: {
        ...
        upsertCoverage: (pfjId, data) => api.put(`/api/hospital/economic/pfj/${pfjId}/coverage`, data),
        listCharges: (params) => api.get('/api/hospital/economic/charges', params),
        requestAuthorization: (pfjId, data) => api.post(`/api/hospital/economic/pfj/${pfjId}/authorizations`, data),
        decideAuthorization: (authId, data) => api.patch(`/api/hospital/economic/authorizations/${authId}`, data),
        recognizePatient: (pfjId) => api.post(`/api/hospital/economic/pfj/${pfjId}/recognize/patient`, null),
        recognizeInsurer: (pfjId) => api.post(`/api/hospital/economic/pfj/${pfjId}/recognize/insurer`, null),
        buildClaim: (pfjId, data) => api.post(`/api/hospital/economic/pfj/${pfjId}/build-claim`, data),
