...
def search_items(
    ...
    Returns minimal data: id, name, base_unit, price (default_cost), sku.
    No relations, no units array, no stock/batches.
    Optimized with ordering for consistent results.
    """
