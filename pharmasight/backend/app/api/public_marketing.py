...
from app.api.auth import StartDemoRequest, StartDemoResponse, start_demo_api_response
...
@router.post("/public/signup", response_model=StartDemoResponse, status_code=status.HTTP_201_CREATED)
@limiter.limit("10/hour")
def public_signup(request: Request, body: StartDemoRequest):
    """
