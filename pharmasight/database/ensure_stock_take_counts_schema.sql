-- =====================================================
-- ENSURE STOCK_TAKE_COUNTS HAS ALL REQUIRED COLUMNS
-- =====================================================
-- Run this if you see "column stock_take_counts.batch_number does not exist"
-- or similar. Safe to run multiple times (idempotent).
-- =====================================================

-- Batch / unit columns (from add_stock_take_batch_fields.sql)
...
-- Verification columns (from add_stock_take_verification.sql)
...
-- Shelf location NOT NULL (only if table has NULLs)
